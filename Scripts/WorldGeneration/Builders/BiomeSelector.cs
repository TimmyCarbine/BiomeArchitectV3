...
namespace BiomeArchitectV3.Scripts.WorldGeneration.Builders
{
    ...
    {
        public static BiomeSelectionResult SelectBiomes(DeterministicRng rng, BiomeRegistry registry, int skyCount, int surfaceCount, int undergroundCount)
        {
        ...
        private static List<BiomeDef> SelectBiomesWeighted(DeterministicRng rng, IReadOnlyList<BiomeDef> pool, int count)
        {
        ...
        private static int GetWeightedIndex(DeterministicRng rng, IReadOnlyList<BiomeDef> pool)
        {
            int total = 0;
